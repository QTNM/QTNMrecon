...
#ifndef fullkinreader_HH
#define fullkinreader_HH 1
...
class FullKinematicsSimReader
{
    public:
        FullKinematicsSimReader(TTreeReader& re1, TTreeReader& re2, std::string outbox); // constructor; required
